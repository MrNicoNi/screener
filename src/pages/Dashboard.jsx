...
export function Dashboard() {
    ...
    }, [userProfile?.email, userProfile?.role, teamId])
    ...
    const loadDashboardData = async () => {
        try {
            ...
            if (isAnalyst && !teamId) {
                // For analysts without team filter, load their recent evaluations with scores
    ...
    return (
        <div className="space-y-8">
                    ...
                    {!teamId && (
                        <div className="flex items-center gap-2 bg-slate-100 p-1 rounded-lg">
                            <button
                                ...
                                className={`flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition ${view === 'general'
                                    ? 'bg-white text-navita-blue shadow-sm'
                            ...
                            <button
                                ...
                                className={`flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition ${view === 'teams'
                                    ? 'bg-white text-navita-blue shadow-sm'
                                    : 'text-slate-600 hover:text-slate-900'
                                    }`}
                            >
            ...
            {/* Conditional Rendering: Team View or General View */}
            {view === 'teams' && !teamId ? (
                <TeamDashboardView />
            ) : (
                <>
